# 🎓 EduGates: Indonesian Higher Education Data Pipeline
...
**EduGates Data Pipeline** adalah sistem otomatisasi penarikan (*scraping*), penyaringan (*filtering*), deduplikasi, dan pengayaan data multi-sumber (*multi-source enrichment engine*) untuk seluruh institusi perguruan tinggi di Indonesia.
...
2. **Penyaringan Status Operasional Cerdas:**
   ...
   * **Eksklusi Bersih:** Mengeliminasi otomatis $\approx 2.437$ entitas yang berstatus *Alih Bentuk*, *Tutup*, dan *Alih Kelola*.
...
8. **Narasi Deskripsi 100% Terisi:**
   * Mengambil narasi sejarah resmi dari Wikipedia dengan *fallback* otomatis ke **Factual Description Generator** berbasis metadata resmi PDDIKTI.
9. **Toleransi Kesalahan & Checkpoint Resume:**
   * Dilengkapi penulisan *atomic streaming write* dan file *checkpoint* (`kampus_extracted_checkpoint.json`). Proses yang terputus dapat dilanjutkan seketika dengan flag `--resume`.
...
| 8 | **`banner_url`** | `varchar(500)` | *NULL* (Ditunda untuk migrasi Cloud Object Storage) |
...
## 🚀 Panduan Memulai Cepat (*Quickstart in 3 Minutes*)
...
```
*Hasil akan langsung terbentuk di `data/output/kampus_extracted.csv`.*

---

## 💻 Panduan Perintah CLI (*Command Cheatsheet*)
...
| **Melanjutkan Proses yang Terputus (*Resume Checkpoint*)** | `python -m src.main --enrich-kampus --resume` |
...
## 📚 Indeks Dokumentasi Lengkap (*Documentation Hub*)
...
* 📄 **[Dokumentasi Proses Ekstraksi Formal (`docs/data_extraction_process.md`)](docs/data_extraction_process.md)**: Laporan proses ekstraksi resmi Sprint 1 proyek EduGates.
...
* **Proyek:** EduGates (Platform Analisis & Portal Informasi Pendidikan Tinggi Indonesia)
* **Sprint:** Sprint 1 – *Scrapping & Build Data Structure*
* **Author / Data Engineer:** I Nengah Sumerta Yasa (Yasa)
* **Kontak & Kontribusi:** Silakan ajukan *Pull Request* atau diskusikan pada channel komunikasi tim untuk pengembangan fitur berikutnya.
